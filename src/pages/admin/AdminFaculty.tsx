...
const AdminFaculty: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({ title: "Success", description: "Faculty member saved successfully." });
                            ...
                            <CardContent className="p-4">
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    <div className="flex gap-1">
                                        ...
                                        <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive" onClick={() => handleDelete(member.id)}>
                                            <Trash2 size={14} />
                                        </Button>
                                    </div>
                                </div>
