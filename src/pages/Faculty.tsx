            ...
            <div className="container px-4 md:px-6">
                <div className="text-center mb-12 space-y-4">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Meet the dedicated educators and staff members who make GCFM a center of excellence.
                    </p>
                </div>
                            ...
                            >
                                <Card className="h-full bg-card/50 backdrop-blur-sm border-primary/10 hover:border-primary/30 transition-colors group overflow-hidden">
                                    ...
                                    <CardHeader>
                                        ...
                                        <CardDescription className="font-medium text-primary/80">{member.designation}</CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <p className="text-sm text-muted-foreground line-clamp-3">
                                            {member.description || "Dedicated faculty member of Government College For Men Nazimabad."}
                                        </p>
                                    </CardContent>
                                </Card>
                            </motion.div>
