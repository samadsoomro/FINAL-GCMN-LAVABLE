...
const PrincipalMessage: React.FC = () => {
    ...
    const principal = data?.name ? data : {
        name: "Principal Name",
        message: "Welcome to GCFM Library. We are dedicated to providing the best educational resources for our students.",
        imageUrl: null
    };
                        ...
                        <CardContent className="p-0">
                            <div className="flex flex-col md:flex-row">
                                <div className="md:w-1/3 bg-muted/30 p-8 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-border/50">
                                    ...
                                    <h3 className="text-xl font-bold text-center text-foreground">{principal.name}</h3>
                                    <p className="text-sm text-primary font-medium mt-1">Principal, GCFM</p>
                                </div>
